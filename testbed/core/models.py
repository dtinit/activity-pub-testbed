...
class Note(models.Model):
    linked_to = models.ForeignKey(Actor, on_delete=models.CASCADE, related_name="notes")
    ...
    def __str__(self):
        return f"Note by {self.linked_to.username}: {self.content[:30]}"
    ...
    def get_json_ld(self):
        return {
            ...
            "linked_to": f"https://example.com/users/{self.linked_to.username}",
